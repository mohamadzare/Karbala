...
//  }
  ...
  public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo)
  {
    if (v.getId() == R.id.alarm_list)
    {
      ...
      menu.add(Menu.NONE, CONTEXT_MENU_EDIT, Menu.NONE, "به روز رسانی");
      menu.add(Menu.NONE, CONTEXT_MENU_DELETE, Menu.NONE, "حذف");
      menu.add(Menu.NONE, CONTEXT_MENU_DUPLICATE, Menu.NONE, "بارگزاری مجدد");
    }
  }
  ...
  public void onBackPressed() {
    startActivity(new Intent(AlarmMe.this,a_Circle_list_menu.class));
    finish();
  }
